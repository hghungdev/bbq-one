...
<template>
  ...
  <div class="bbq-popup" :style="popupStyle">
    ...
    <div class="bbq-popup__header">
      ...
      <button class="bbq-popup__close" type="button" @click="props.onClose" aria-label="Close">×</button>
        ...
        <section class="bbq-popup__pane" aria-label="Source">
          ...
          <div class="bbq-popup__row">
            ...
            <div class="bbq-popup__pane-body">
              ...
              <p v-if="result.enrichment?.phonetic" class="bbq-popup__ipa">{{ result.enrichment.phonetic }}</p>
            ...
            <div v-if="canSaveKeyword" class="bbq-popup__target-actions">
              ...
              <template v-if="isAuthenticated">
                ...
                >
                  ...
                  <svg class="bbq-popup__save-icon-svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
